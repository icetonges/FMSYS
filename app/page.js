    ...
    <main>
      ...
      <section className="hero suite-hero">
        <div className="hero-copy">
          ...
          <p>
            Navigate between GFEBS, GCSS-Army, GCSS-MC, Navy ERP, DAI, DEAMS, GAFS, CEFMS, DLA EBS, ABSS, and future DoD financial management systems using a shared audit-readiness,
