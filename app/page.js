    ...
    <main>
      ...
      <section className="hero suite-hero">
        <div className="hero-copy">
          ...
          <p>
            Navigate between GFEBS, GCSS-Army, LMP, GCSS-MC, STARS, SABRS, FAMIS, DDRS, GTAS/CARS, DoD-to-Treasury Close, ADS/DDS/DCAS, IPAC, MOCAS, PIEE, Navy ERP, DAI, DEAMS, GAFS, CEFMS, DLA EBS, ABSS, and future DoD financial management systems using a shared audit-readiness,
